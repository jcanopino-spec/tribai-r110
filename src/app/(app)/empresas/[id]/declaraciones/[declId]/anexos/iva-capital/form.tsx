...
export function IvaCapitalForm({ declId, empresaId }: { declId: string; empresaId: string }) {
  ...
  return (
    <div className="border border-border p-5">
      <h2 className="font-serif text-xl">Agregar bien de capital</h2>
      <form ref={formRef} action={formAction} className="mt-5 space-y-4">
        ...
        <Field label="Bien adquirido">
          <Input name="bien" required placeholder="Maquinaria, equipo de cómputo…" />
        </Field>
